...
public class Exercício2 {
		...
		public static void main(String[] args) {
     	...
     	//2. Faça um programa que leia a idade de uma pessoa expressa em dias e mostre-a
		//expressa em anos, meses e dias (considere que: 1 ano = 365 dias / 1 mês = 30 dias e 1 dia = 1 dia em todos os casos).
